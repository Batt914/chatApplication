...
public class ProgressCircleUI extends BasicProgressBarUI  {
    ...
    public ProgressCircleUI(progress pro) {
        this.pro=pro;
        imageDown = new ImageIcon(getClass().getResource("/testingpic/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/testingpic/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/testingpic/file.png")).getImage();
